    ...
    public class FillableContent
    {
        ...
        public static FillableContent ArtisanGuild = new FillableContent(
            ...
            new FillableEntry[]
            {
                ...
                new FillableEntry( 1, typeof( Static ), 0x1224 ), // StatueEast2
                new FillableEntry( 1, typeof( Static ), 0x139A ), // StatueSouth
                new FillableEntry( 1, typeof( Static ), 0x1225 ), // StatueSouthEast
                new FillableEntry( 1, typeof( Static ), 0x1226 ), // StatueWest
                new FillableEntry( 1, typeof( Static ), 0x139B ), // StatueNorth
                new FillableEntry( 1, typeof( Static ), 0x139C ), // StatueEast
                new FillableEntry( 1, typeof( Static ), 0x12CA ), // BustEast
                new FillableEntry( 1, typeof( Static ), 0x12CB ), // BustSouth
        ...
        public static FillableContent Carpenter = new FillableContent(
            ...
            new FillableEntry[]
            {
                new FillableEntry( 1, typeof( Static ), 0x1026 ),  // Chisels [North]
                new FillableEntry( 1, typeof( Static ), 0x1027 ),  // Chisels [West]
        ...
        public static FillableContent Painter = new FillableContent(
            ...
            {
                new FillableEntry( 1, typeof( Static ), 0xFC1 ),  // PaintsAndBrush
                new FillableEntry( 1, typeof( Static ), 0xFBF ),  // PenAndInk
        ...
        public static FillableContent Tinker = new FillableContent(
            ...
            new FillableEntry[]
            {
                ...
                new FillableEntry( 1, typeof( Static ), 0x1024 ),  // ArrowShafts
                new FillableEntry( 1, typeof( Static ), 0x14FD ),  // Lockpicks
                new FillableEntry( 1, typeof( Static ), 0x1EBA ),  // ToolKit
